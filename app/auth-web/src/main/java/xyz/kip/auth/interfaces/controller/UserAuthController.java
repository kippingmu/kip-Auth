package xyz.kip.auth.interfaces.controller;
...
import xyz.kip.auth.application.service.UserAuthService;
...
public class UserAuthController {
    ...
    public Result<UserAuthDTO> register(@RequestBody RegisterRequestDTO registerRequest) {
    ...
    public Result<UserAuthModel> getUser(@PathVariable String userId) {
        return userAuthService.queryByUserId(userId);
    }
    ...
    public Result<UserAuthModel> getUserByName(@PathVariable String username) {
        return userAuthService.queryByUsername(username);
    }
     ...
     */
    @PutMapping("/user")
    public Result<Boolean> updateUser(@RequestBody UserAuthModel userAuth) {
        return userAuthService.updateUser(userAuth);
    }
